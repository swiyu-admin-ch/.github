# Welcome to the swiyu Sandbox Trust Infrastructure ecosystem
...
- **swiyu Sandbox Wallet**: Users will be able to download the swiyu Sandbox Wallet, request Beta-ID credentials for testing purpose, manage their VCs and interact with the ecosystem.
